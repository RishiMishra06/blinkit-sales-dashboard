...
![Dashboard Home](Blinkit%20Dashboard%202.png)
![Dashboard View](Blinkit%20Dashboard%201.png)
...
```
├── Blinkit Dashboard.pbix     # the Power BI file
├── Blinkit_Excel_Data.xlsx    # dataset
├── Blinkit Dashboard.pdf      # exported view of the dashboard
├── Blinkit Dashboard 1.png    # screenshot
├── Blinkit Dashboard 2.png    # screenshot (home page)
└── README.md
```
